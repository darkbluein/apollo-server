...
export default gql`
    ...
    type Mutation {
        ...
        alterOrderState(id: String!, accepted: Boolean, cancel: Boolean, products: [String]): Boolean!
        ...
        updateAccount(id: String!, accountId: String!, paid: Boolean, method: String): StoreAccount!
    }
    type Subscription {
